...
public class StreamCipher {
    ...
    /**
     * Encrypts or decrypts the input file using XOR and writes the result to the
     * output file.
     *
    ...
    public static void encryptDecrypt(String inputFile, String outputFile, BigInteger key) {
        try {
            ...
            // I take inspiration to use "Path" from
            ...
            MyRandom prng = new MyRandom(key.longValue());

            /**
             * Performs the XOR operation on each bit of the input bytes array with a random
             * byte generated by the
             * provided PRNG (pseudo-random number generator), and returns the resulting
             * byte array.
             * 
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 3) {
            ...
            System.out.println(
                    "Incorrect input format. Please use the following format: StreamCipher <key> <inputFile> <outputFile>");
            System.exit(1);
        }
